...
![Wireframe](https://github.com/LaurenCBullock/Sims3Tut/blob/master/6.PNG?raw=true)![BodyTex](https://github.com/LaurenCBullock/Sims3Tut/blob/master/key_00b2d882_00000000_b4cdc208d8d51bee.png?raw=true)
...
![Texture](https://github.com/LaurenCBullock/Sims3Tut/blob/master/shirt.png?raw=true)![Shirt](https://github.com/LaurenCBullock/Sims3Tut/blob/master/7.PNG?raw=true)
...
Now open the Mesh Toolkit and go to the tab labeled Auto tools for WSO. For this you need both your template item from the game and the 

one you just exported as .wso.

We want to do both things this tab offers, auto-assign bones and auto-create Morphs

First auto-create bones by selecting the mesh you created in the top blank and the one you want to use as a template in the bottom and
clicking and save. Don’t overwrite a file as this step can go wrong. 
...
![Imported model](https://github.com/LaurenCBullock/Sims3Tut/blob/master/9.PNG?raw=true)
...
![Texture Tab](https://github.com/LaurenCBullock/Sims3Tut/blob/master/10.PNG?raw=true)
...
![CSH](https://github.com/LaurenCBullock/Sims3Tut/blob/master/shirtoverlay.png?raw=true)![Shirt Tex](https://github.com/LaurenCBullock/Sims3Tut/blob/master/shirt.png?raw=true)
...
![Mask](https://github.com/LaurenCBullock/Sims3Tut/blob/master/mask.png?raw=true)

So currently your project should look something like this, except the cool colors.

![Current](https://github.com/LaurenCBullock/Sims3Tut/blob/master/12.PNG?raw=true)
...
![Patterns](https://github.com/LaurenCBullock/Sims3Tut/blob/master/12.PNG?raw=true)
...
![Patterns](https://github.com/LaurenCBullock/Sims3Tut/blob/master/13.PNG?raw=true)
...
![Norm good](https://github.com/LaurenCBullock/Sims3Tut/blob/master/normal.png?raw=true)![Norm base](https://github.com/LaurenCBullock/Sims3Tut/blob/master/notcorruptnormal.png?raw=true)
...
Voila! You’re done! Startup sims3 and enter CAS look at your new item.
 ...
 ![Final](https://github.com/LaurenCBullock/Sims3Tut/blob/master/14.PNG?raw=true)
